...
| What do those alternatives leave unaddressed? | The structural choices this methodology commits to (cheating-agent defense, locks-for-humans+agents, challenge-before-consenting, four-layer planning, DoD coupled to item frontmatter, tier matrix for loops, periodic deep-eval) cover gaps the maintainer judged worth filling. | _(maintainer-private analysis; not shipped publicly — see [README "Why this exists"](../../README.md#why-this-exists))_ |
| How will the maintainer know this is working? | Qualitative signals (early: external adoption stories appear, forks have commits, self-development cycle ships methodology improvements; sustained: the methodology appears in field discussions on its own merit, at least one team uses it publicly + sustainably) + one operational rule (maintainer time stays sustainable). No public star-count or company-count targets. | [05_success_metrics.md](05_success_metrics.md) |
