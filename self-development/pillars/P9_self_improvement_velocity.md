...
- [ ] The cycle has shipped methodology improvements (not just self-development cleanup); CHANGELOG entries attribute specific changes to cycle output. See [brief/05_success_metrics.md "Early signals"](../brief/05_success_metrics.md#early-signals-first-year).
