...
_Last refreshed: 2026-08-20 (E10 chartered and fully executed; staged for v1.32.0; 8 done, 1 active with 0 open items, 0 planned, 1 parked.)_
...
**Counts:** **1 active** (E10), 0 planned, 8 done (E01, E02, E03, E05, E06, E07, E08, E09), 1 parked (E04 — will not resume). **The backlog is no longer empty**, and for the first time the work in it was demanded from outside rather than selected from a landscape.
