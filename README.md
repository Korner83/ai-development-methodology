...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img alt="Methodology version" src="https://img.shields.io/badge/methodology-v1.21.0-1e40af"></a>
...
- Battle-tested in one production project + self-applied (see [`self-development/`](self-development/)). Currently [v1.21.0](CHANGELOG.md).
...
~13,800+ lines across 60+ files at v1.21.0. Longest doc ~1,000 lines. Each doc is self-contained - read in any order.
...
Battle-tested in one production project. Currently v1.21.0 - see [CHANGELOG.md](CHANGELOG.md) and [STATUS.md](STATUS.md). Maintenance is lean - PRs welcome, no SLA. CC BY 4.0 means fork freely if you want a more actively-maintained version.
